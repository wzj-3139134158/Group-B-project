  ...
  <div class="index">
    ...
    <div class="Content">
      <div class="content_dir">
        ...
        <router-link to="/staff" class="COnfirm">确认</router-link>
      </div>
      <!-- 内容目录 -->
      <table class="content_manager">
        <thead>
          <th style="margin-left:44px;font-size: 19px;color:#666666;float: left; ">姓名</th>
          <th style="margin-left:128px;font-size: 19px;color:#666666;float: left; ">手机号</th>
          <th style="margin-left:128px;font-size: 19px;color:#666666;float: left; ">账号</th>
          <th style="float: left; margin-left:128px;font-size: 19px;color:#666666;">密码</th>
          <div class="Quanxuan">    <label class="quanxuan" >全选</label>
          <input type="checkbox" class="QUanxuan" :checked="chooseAll" @click="chooseAllCart"  /></div>
          <!-- 以下是el -->
          <el-button @click="drawer = true" type="primary" id="content_btn" style="display: none;">新建</el-button>
      ...
      <tbody v-for="(item,id) in list" class="content_repair">
        <tr>
          ...
          <!-- 密码 -->
          <el-button @click="details_btn(id)" type="primary" style="display: none;" id="content_check">详情</el-button>
        </tr>
        <el-drawer
          size="699px;
        height:100%;
